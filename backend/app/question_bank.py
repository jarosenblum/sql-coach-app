...
QUESTION_BANK = {
    "Q1": {
        ...
        "syntax_pattern": "SELECT * FROM Insert_Table_Name;",
    ...
    "Q2": {
        ...
        "syntax_pattern": "SELECT CustomerName, Insert_other_column_name FROM table_name;",
    ...
    "Q3": {
        ...
        "syntax_pattern": "SELECT * FROM Table_Name WHERE column_name = 'value';",
    ...
    "Q4": {
        ...
        "syntax_pattern": "SELECT * FROM ______ WHERE column_name = 'value' OR column_name = 'value';  -- OR is the new command here",
    ...
    "Q5": {
        ...
        "syntax_pattern": "______ * FROM ______ ORDER BY column_name;  -- ORDER BY is the new command here",
    ...
    "Q6": {
        ...
        "syntax_pattern": "SELECT DISTINCT ______ FROM ______;  -- DISTINCT is the new command here",
    ...
    "Q7": {
        ...
        "syntax_pattern": "______ COUNT( ___ ) FROM ______;  -- COUNT is the new command here",
    ...
    "Q8": {
        ...
        "syntax_pattern": "______ ______, ______ FROM ______ GROUP BY ______;  -- GROUP BY is the new command here",
    ...
    "Q9": {
        ...
        "syntax_pattern": "______ ______, ______ FROM ______ ______ ______ HAVING ______;  -- HAVING is the new command here",
    ...
    "Q10": {
        ...
        "syntax_pattern": "______ ______.______ , ______.______ FROM ______ JOIN ______ ON ______ = ______;  -- JOIN is the new command here",
    ...
    "Q11": {
        ...
        "syntax_pattern": "______ ______, ______ ______ ______ ______ ON ______ = ______ ______ ______;  -- combine prior commands here",
